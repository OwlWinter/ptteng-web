...
<#--        <%--轮播图（banner）--%>-->
<#--        <c:forEach var="banner" items="${banners}" varStatus="imgCount">-->
<#--            <c:if test="${imgCount.index == 0}">-->
<#--                <div class="item active">-->
<#--                    <img src=${ctx!"/static"}/imges/${banner.imges}"/>-->
<#--                </div>-->
<#--            </c:if>-->
<#--            <c:if test="${imgCount.index > 0}">-->
<#--                <div class="item">-->
...
<#--            <i class="icon-left"><img src=${ctx!"/static"}/imges/54354.png"></i>-->
<#--        </a>-->
<#--        <a data-slide="next" href="#myCarousel" class="carousel-control right">-->
<#--            <i class="icon-right"><img src=${ctx!"/static"}/imges/4525424.png"></i>-->
<#--        </a>-->
...
<#--       freemarker 轮播图-->
        <#list bannerList as item>
            <#if item?index == 0>
                <div class="item active">
                    <img src="${ctx!"/static"}/imges/${item.imges}"/>
                </div>
            <#else >
                <div class="item">
                    <img src="${ctx!"/static"}/imges/${item.imges}"/>
    ...
    <div class="main-a row">
            ...
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${ctx!"/static"}/imges/45354312.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${ctx!"/static"}/imges/879789.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${ctx!"/static"}/imges/786453654365.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="${ctx!"/static"}/imges/453254312.png">${statistics['total']}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="${ctx!"/static"}/imges/453254312.png">${statistics['employment']}<br>
...
<#--                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">-->
<#--                    <div>-->
<#--                        <img src=${ctx!"/static"}/imges/${representative.imges}">-->
<#--                        <span><c:out value="${representative.major}:${representative.name}"/></span>-->
<#--                        <p class="text-left"><c:out value="${representative.introduction}"/></p>-->
<#--                    </div>-->
<#--                </li>-->
<#--            </c:forEach>-->
<#--        </ul>-->
<#--    </div>-->
            ...
            <ul class="list-unstyled text-center">
                <#items as item>
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            <img src="${ctx!"/static"}/imges/${item.imges}">
                            <span>${item.major}:${item.name}</span>
                            <p class="text-left">${item.introduction}</p>
                        </div>
                    </li>
                </#items>
            </ul>
    ...
    <div class="row main-bottom">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="logo">
                <li>
                    <a href=""><img src="${ctx!"/static"}/imges/123132.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${ctx!"/static"}/imges/1549865.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${ctx!"/static"}/imges/785345.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${ctx!"/static"}/imges/1471.png"></a>
                </li>
                <li>
                    <a href="">  <img src="${ctx!"/static"}/imges/7861.png"></a>
                </li>
            </ul>
        </div>
    </div>
