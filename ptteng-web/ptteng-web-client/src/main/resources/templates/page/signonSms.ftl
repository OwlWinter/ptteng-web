    ...
    <form action="/signon/user" method="post" >
        <table>
            <tr>
                ...
                <a href="/register/mail" style="color: #5bc0de">使用邮箱注册</a>
            </tr>
            <tr>
                <td>输入密码：</td>
            ...
            <tr>
                <td>手机号码：</td>
                <td>
                    <input id="mobile" name="phoneNumber" type="text" required/>
                    <input id="code" name="code" type="text" required>
                    <input id="j-get-code" type="button" value="免费获取验证码" onclick="fasong()"/>
                </td>
            </tr>
            <tr>
